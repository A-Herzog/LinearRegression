...
function start() {
  ...
  if (isDesktopApp) {
    ...
    const downloadA='<a id="downloadApp" target="_blank" href="https://github.com/A-Herzog/LinRegression/releases/latest/download/LinRegression.exe" style="display: none;"></a>';
